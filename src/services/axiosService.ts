...
const axiosService = async (): Promise<AxiosInstance> => {
    ...
    const accessToken = tokenManager.getAccessToken() || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY1ZmRhNjM0YzljYTBjNDkwMTdlODMwNSIsImlhdCI6MTcxMTEyMTk5OCwiZXhwIjoxNzExNzI2Nzk4fQ.5m_t68AqimxabIdZ2-R-H6sjegmQnWgOJL9NJ6cvHDg';
