...
const BuyActionItem = ({ label, Icon, onPress, isActive, wrapperClassName }: BuyActionItemProps) => {
  return (
    <View className={`items-center w-1/4 relative ${wrapperClassName}`}>
      ...
      <View className='absolute top-[10px] left-3'>
        ...
        >
          ...
          <Text className={`font-nunito-700 text-xs pb-2 ${isActive ? 'text-zinc-700' : ' text-zinc-500'}`}>
            {label}
          </Text>
        </View>
      </View>
